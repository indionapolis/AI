...
set_world :-
    % Sample test #1
    % asserta(gold_location(position(2,4))),
    % asserta(wumpus_location(position(1,4))),
    %
    % asserta(pit_location(position(3,1))),
    % asserta(pit_location(position(3,3))),
    % asserta(pit_location(position(4,4))).

    % Sample test #2
    % asserta(gold_location(position(2,4))),
    % asserta(wumpus_location(position(1,4))),
    %
    % asserta(pit_location(position(1,3))),
    % asserta(pit_location(position(2,3))),
    % asserta(pit_location(position(3,3))),
    % asserta(pit_location(position(4,3))).

    % Sample test #3
    asserta(gold_location(position(1,4))),
    asserta(wumpus_location(position(2,4))),
